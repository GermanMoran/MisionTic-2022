...
public class Empresa {
    ...
    /* Liquidar salario de la empresa*/
     public static ArrayList<Double> totalPagosOtorgadosAEmpleados (ArrayList<Empleado> empleados){
         ArrayList<Double> totalPagosEmp = new ArrayList();
         
         
         
        double totals = 0, primas, intereses,vacaciones, prestaciones,cesantias, auxilio,salarioEmp;
        double valh = 0;
     ...
     for(int x= 0; x<empleados.size(); x++){
         ...
         salarioEmp = totals+ prestaciones;
         totalPagosEmp.add(salarioEmp);
        }
     return totalPagosEmp;
     }
}
